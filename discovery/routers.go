...
func getRoutes() []Route {
	return []Route{
		...
		},
		{
			...
			HTTPSCPDomainRoutingInfoGet,
		},
		{
			"ScpDomainRoutingInfoSubscribe",
			http.MethodPost,
			"/scp-domain-routing-info-subs",
			HTTPScpDomainRoutingInfoSubscribe,
		},
		{
			"RetrieveStoredSearch",
			http.MethodGet,
			"/searches/:searchId",
			HTTPRetrieveStoredSearch,
		},
		{
			"OnScpDomainRoutingInformationChangePost",
			http.MethodPost,
			"/:$request.body#/callbackUri",
			HTTPOnScpDomainRoutingInformationChangePost,
		},
	}
}
